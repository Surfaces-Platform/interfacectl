...
export type ExternalReferenceSystem = "figma" | "code" | "story" | "url" | "asset";
...
export type ContractSlotKind = "text" | "richText" | "media" | "action" | "icon" | "container" | "item-list";
...
export type ContractInteractionEffect = "navigate" | "open" | "close" | "submit" | "filter" | "toggle" | "expand" | "collapse" | "select" | "set-state";
...
export type SectionAllowedOperation = "update-copy" | "swap-variant" | "reorder-items" | "change-media" | "adjust-layout" | "bind-data" | "wire-interaction";
export interface SectionEditPolicy {
    mode: SectionEditMode;
    allowedOperations?: SectionAllowedOperation[];
}
export type ResponsiveLayoutIntent = "stack" | "columns" | "auto-fit-grid" | "sidebar-main" | "single-column-form";
export type ResponsiveSlotBehaviorKind = "stack" | "inline" | "grid" | "hide" | "collapse" | "pin";
